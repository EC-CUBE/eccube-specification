...
1. "アップロード"ボタンを押下する
1. 「phpファイルはアップロードできません」のエラーメッセージが表示される
...
1. メンテナンス管理
1. "有効にする"ボタンを押下
1. フロント画面にアクセスし、正常にサイトが表示されることを確認
1. 画面上部に「メンテナンスモードが有効になっています」との文言が表示されることを確認
1. ログアウトする
1. ログアウト状態でフロント画面にアクセスし、メンテナンスモードの画面が表示されることを確認

## EA0607-UC08-T01_メンテナンス管理(有効→無効)
1. メンテナンス管理
1. "無効にする"ボタンを押下
