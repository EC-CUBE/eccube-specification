...
## EA0301-UC01-T06_商品一覧でのソート

1. 商品管理 → 商品一覧
1. 一覧の「商品名」の横の ▲▼ボタンを押し、商品名の昇順・降順で一覧ページの表示がソートされることを確認
1. 一覧の「更新日」の横の ▲▼ボタンを押し、更新日の昇順・降順で一覧ページの表示がソートされることを確認
1. 一覧の「ID」の横の ▲▼ボタンを押し、IDの昇順・降順で一覧ページの表示がソートされることを確認
...
## EA0309-UC03-T01_カテゴリ表示順の変更（マウスで変更）
