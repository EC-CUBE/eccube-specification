...
## EA0401-UC03-T02_出荷情報のCSV出力 項目変更設定
...
## EA0401-UC06-T02_受注編集(一覧からステータス変更・メール通知)
...
1. 見出し「購入金額」の横の上矢印ボタン(不有効）をクリックすると上矢印ボタンが有効にされる。
1. 購入金額の昇順にソートが行われることを確認
1. 見出し「購入金額」の横の上矢印ボタン（有効にされた）をクリック
