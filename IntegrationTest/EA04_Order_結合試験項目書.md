...
## EA0401-UC01-T04_受注一覧でのソート

1. 受注管理 → 受注一覧
1. 一覧の「購入金額」の横の ▲▼ボタンを押し、購入金額の昇順・降順で一覧ページの表示がソートされることを確認
1. 一覧の「対応状況」の横の ▲▼ボタンを押し、対応状況の昇順・降順で一覧ページの表示がソートされることを確認
1. 一覧の「注文者」の横の ▲▼ボタンを押し、注文者の昇順・降順で一覧ページの表示がソートされることを確認
